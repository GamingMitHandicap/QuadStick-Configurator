...
class VirtualGamepadEmulator(object):
    ...
    def unbuffered_update (self, qs_data):
        ...
        try:
            ...
            print(traceback.format_exc())
            self._log("Error in virtual gamepad update. Restart QC")

    def reset(self):
        self.gamepad.reset()

    def update_X360_with_PS3 (self, qs_data): # QuadStick not in PS4 boot mode
        # print(repr(qs_data))
    ...
    def update_X360_with_X360CE (self, qs_data): # QuadStick in X360CE mode
        #print(repr(qs_data))
    ...
    def update_X360_with_PS4 (self, qs_data): # QuadStick in PS4 boot mode
        #print(repr(qs_data))
