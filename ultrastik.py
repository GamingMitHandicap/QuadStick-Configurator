        ...
        try:
            ...
            for i in range(10):
                ...
                if self._report_count > 0:
                    self.log('UltraStik 360 Joystick ' + str(device_id + 1) + ' interface successfully opened') # Can't use %d format
            ...
            self.log( '**** Failed to open UltraStik 360 Joystick ' + str(device_id + 1) + " Try closing program and re-opening ****" ) # Can't use %d format
