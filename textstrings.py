...
FILE_LIST_HTML_HEADER_de = """<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html>
<head>
  <meta content="text/html; charset=utf-8" http-equiv="content-type">
  <title>QuadStick Dateiauswahl</title>
</head>
<body>
<div style="text-align: center;">QuadStick Dateiauswahl.<br>
</div>
<br>
<div style="text-align: center;">Beginne mit einem langen Saugen an dem seitlichen Rohr.
Wenn die violette LED zu blinken beginnt, bewege den Joystick nach rechts oder links, um
die gewünschte Datei auszuwählen. Drücke die Lippentaste, um die Datei auszuwählen.<br>
</div>
<br>
<table style="text-align: center; margin-left: auto; margin-right: auto; " border="1" cellpadding="2" cellspacing="2">
  <tbody>
    <tr>
      <td style="width: 110px; text-align: center;"><span style="font-weight: bold;">LED-Muster</span></td>
      <td style="width: 50px; text-align: center;"><span style="font-weight: bold;">ID</span></td>
      <td style="width: 150px;"><span style="font-weight: bold;">CSV Dateiname</span></td>
      <td style="width: 400px;"><span style="font-weight: bold;">Name des Spreadsheets</span></td>
    </tr>
"""
