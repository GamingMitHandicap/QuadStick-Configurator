...
def load_preferences_file(mainWindow):
    ...
    if d is None:
        if mainWindow.microterm:
            #mainWindow.SendConsoleMessage("Searching for Bluetooth or serial connection...")
            ...
            if mt.serial:
                ...
                if len(csvfile) > 3:
                    ...
                    for row in reader:
                        ...
                        row_count += 1
                    return preferences
        #mainWindow.SendConsoleMessage("Serial connection not found.")
        return None
